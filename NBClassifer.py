...
def test_train_split(embeddings,seed=42):
	trainX, testX, trainY, testY = train_test_split(embeddings['Cleaned'],embeddings['Label'],test_size=0.30,random_state=seed)
...
if __name__ == '__main__':
	...
	df_tain = pd.read_csv('./raw_data/alta/train_alta_dataset.csv')
