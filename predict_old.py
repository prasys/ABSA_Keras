...
if __name__ == '__main__':
    ...
    saveFolder = './data/output/42'
    filePath = './raw_data/alta/test_output_42.csv'
    ...
    prepro.process_predict(saveFolder, lambda x: prepro.spacyTokenizer(x), True) # this would do the pre_processing for the data to predict
