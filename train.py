...
if __name__ == '__main__':
    ...
    train_model('alta', 'twitter', 'word', 'td_lstm')
    train_model('alta', 'twitter', 'word', 'tc_lstm')
    train_model('alta', 'twitter', 'word', 'ae_lstm')
    train_model('alta', 'twitter', 'word', 'at_lstm')
    train_model('alta', 'twitter', 'word', 'atae_lstm')
    train_model('alta', 'twitter', 'word', 'memnet')
    train_model('alta', 'twitter', 'word', 'ram')
    train_model('alta', 'twitter', 'word', 'ian')
    train_model('alta', 'twitter', 'word', 'cabasc')
