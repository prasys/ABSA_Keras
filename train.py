...
def train_model(data_folder, data_name, level, model_name, classWeights=None):
...
if __name__ == '__main__':
    ...
    train_model(data_folder='alta2', data_name='twitter', level='word', model_name='td_lstm',classWeights=class_weight)
