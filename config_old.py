...
class Config(object):
    def __init__(self):
        ...
        self.left_max_len = {'laptop': {'word': 77, 'char': 366}, 'restaurant': {'word': 72, 'char': 344},
                             'twitter': {'word': 100, 'char': 156}} # original is 39
        self.right_max_len = {'laptop': {'word': 78, 'char': 362}, 'restaurant': {'word': 72, 'char': 326},
    ...
    def init_input(self):
        if self.model_name == 'td_lstm':
            ...
            self.use_aspect_input, self.use_aspect_text_input = True, False #False,False
